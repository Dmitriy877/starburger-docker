...
Данный скрипт автоматически установит все пакеты python, JS, пересоберет статику, JS, выполнит миграции, перезагрузит службы проекта

ВАЖНО файл *.service проекта должен называться starburger.service, а переменное окружение venv
